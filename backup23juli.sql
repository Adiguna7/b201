...
-- Dump completed on 2020-07-23  3:08:34
-- MySQL dump 10.13  Distrib 5.7.30, for Linux (x86_64)
--
...
CREATE TABLE `failed_jobs` (
  ...
  CONSTRAINT `failed_jobs_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
...
INSERT INTO `failed_jobs` VALUES (6,515,2,NULL,NULL);
...
CREATE TABLE `forgot_pass` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `userId_UNIQUE` (`userId`),
  CONSTRAINT `forgot_pass_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
...
INSERT INTO `users` VALUES (515,'adigunauser','sevensag@gmail.com','12379127396293','120372369862','$2y$10$RAU0z55KRqijpoefhbTleeqmVkHuTcPLZ7cr1DMDaRkEKyo5fLe3a',NULL,1);
