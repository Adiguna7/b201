...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-06-27 02:29:56',NULL),('diagnostics.include_raw','OFF','2020-06-27 02:29:56',NULL),('ps_thread_trx_info.max_length','65535','2020-06-27 02:29:56',NULL),('statement_performance_analyzer.limit','100','2020-06-27 02:29:56',NULL),('statement_performance_analyzer.view',NULL,'2020-06-27 02:29:56',NULL),('statement_truncate_len','64','2020-06-27 02:29:56',NULL);
...
-- Dump completed on 2020-07-19  7:38:18
CREATE DATABASE  IF NOT EXISTS `b201` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `b201`;
-- MySQL dump 10.13  Distrib 5.7.30, for Linux (x86_64)
--
...
INSERT INTO `items` VALUES (53,'asdasd211','Book1.png','asda','book',1,1,1000),(54,'asdasd','Mouse54.png','asdas','mouse',1,1,1500);
...
CREATE TABLE `transaksi` (
  ...
  `transaksi_start` date NOT NULL,
  `transaksi_end` date NOT NULL,
  `transaksi_status` enum('waiting','rent','done') NOT NULL DEFAULT 'waiting',
  PRIMARY KEY (`transaksi_id`),
  KEY `item_id` (`item_id`),
  KEY `userId` (`userId`),
  CONSTRAINT `transaksi_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`),
  CONSTRAINT `transaksi_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`)
...
INSERT INTO `transaksi` VALUES (12,53,28,'2020-07-06','2020-07-07','waiting');
...
INSERT INTO `users` VALUES (27,'adiguna7','sevensag@gmail.com','07211840000052','085961165215','$2y$10$jzYKDFpLaczKu.Kl6o.ChexO2Q3ZDOM1BIJc1J75DLQn9SOVHH.jO',1,1),(28,'adigunauser','sevensag@gmail.com','12312312312312','123012080128','$2y$10$rkuARASoQEse6Sb.OEvzwOI3sTN1IHv6/11.xsoSpL1jBVnwbokm2',NULL,1);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'b201'
--

--
-- Dumping routines for database 'b201'
--
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
